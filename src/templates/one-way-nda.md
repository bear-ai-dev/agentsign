...
This One-Way Non-Disclosure Agreement ("Agreement") is entered into as of {{effective_date}} by and between {{disclosing_party_name}}, located at {{disclosing_party_address}} ("Disclosing Party"), and {{receiving_party_name}}, located at {{receiving_party_address}} ("Receiving Party").

## 1. Purpose

The Disclosing Party may disclose Confidential Information to the Receiving Party solely for {{purpose}} (the "Purpose"). The Receiving Party may use Confidential Information only for the Purpose.
...
This Agreement begins on the effective date and continues for {{term_years}} years. The Receiving Party's confidentiality obligations survive for {{term_years}} years after each disclosure, except that trade secrets remain protected for as long as they qualify as trade secrets under applicable law.
...
This Agreement is governed by the laws of {{governing_law}}, without regard to conflict-of-law rules. The parties consent to jurisdiction and venue in {{court_venue}}.
