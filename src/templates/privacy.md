...
This Privacy Policy covers how we treat Personal Data that we gather when you access or use our Services. "Personal Data" means any information that identifies or relates to a particular individual and also includes information referred to as "personally identifiable information," "personal information," or "sensitive personal information" under applicable data privacy laws, rules, or regulations. This Privacy Policy does not cover the practices of companies we do not own or control or people we do not manage.

## Personal Data we collect

We may collect the categories of Personal Data below from contributors.

### Profile and contact data

Includes your first and last name, email address, phone number, languages spoken, and any skill or expertise tags you provide. We collect this to provide, customize, and improve the Services; operate the contributor marketplace and process payouts; correspond with you; and for fraud prevention, security, and debugging.
...
Includes financial account information, payment method, last 4 digits of any card on file, billing address, and tax-related information. We collect this to process your payouts, comply with tax reporting requirements, and prevent fraud.

### Government-issued ID and identity-verification data

Where we collect government-issued ID or identity-verification data for KYC or anti-fraud purposes, we use it to verify your identity and eligibility to receive payouts and to comply with anti-money-laundering and tax laws.
...
Includes messages you send to support, survey responses, and your communication preferences. We collect this to respond to you and to improve the Services.

### Device and IP data

Includes IP address, device ID, operating system, browser type, and crash logs. We collect this to provide, customize, and improve the Services; operate the contributor marketplace; correspond with you; and for fraud prevention, security, and debugging.

### Web analytics and approximate geolocation data

Includes page interactions, referring webpage or source, non-identifiable request IDs, IP-address-based location, and similar approximate location signals. We collect this to provide, customize, and improve the Services; market the Services; localize the Services; prevent fraud; and comply with sanctions and export-control laws.

## Our commercial or business purposes for collecting Personal Data

We collect Personal Data to:

- Create and manage contributor accounts.
- Route tasks to contributors and process Submissions.
- Calculate and disburse payouts and issue tax forms where required.
- Provide support and assistance.
- Improve the Services, including testing, research, internal analytics, and product development.
- Personalize Services, website content, and communications.
...
We will not collect additional categories of Personal Data or use Personal Data for materially different, unrelated, or incompatible purposes without providing notice or obtaining consent.

## Sources of Personal Data

We collect Personal Data from you when you create an account, complete your contributor profile, update payout information, voluntarily provide information in free-form text boxes, surveys, or support messages, or use the Services. We may also receive information from third-party credentials and providers, identity-verification, anti-fraud, tax-compliance, and payment providers.
...
We may create aggregated, de-identified, or anonymized data from Personal Data, including by removing information that makes the data personally identifiable to a particular contributor. We may use and disclose such data for lawful business purposes, including to analyze, build, improve, and promote the Services, provided that we will not disclose such data in a manner that could identify you.

## Tracking tools, advertising, and opt-out

The Services use cookies and similar technologies such as pixel tags, web beacons, clear GIFs, and JavaScript (collectively, "Cookies") to recognize your browser, analyze trends, learn about our user base, and operate and improve the Services. The Services do not support "Do Not Track" requests sent from a browser at this time.

We may use Essential Cookies, Performance/Analytical Cookies, and Retargeting/Advertising Cookies. You can decide whether or not to accept Cookies through your internet browser's settings. To find out more about Cookies generally, including how to manage and delete them, please visit http://www.allaboutcookies.org/.
...
We retain Personal Data for as long as necessary to provide the Services or perform our business or commercial purposes for collecting it. In some cases, we retain Personal Data for longer if necessary to comply with legal obligations, resolve disputes, collect amounts owed, or as otherwise permitted or required by applicable law. We may retain information in anonymous or aggregated form where that information would not identify you personally.
...
By signing below, I acknowledge that I have read and understood this Privacy Policy, consent to the collection, use, processing, and disclosure of my Personal Data as described above, and agree that my electronic signature and acknowledgement date are legally binding.
